...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] PERMISSIONS = new String[] {Manifest.permission.INTERNET, Manifest.permission.INTERNET};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checker.lacksPermissions(PERMISSIONS)) {
            Toast.makeText(getApplicationContext(),
                    "no_permissions", Toast.LENGTH_SHORT).show();
    ...
    private void attemptLogin() {
        ...
        if (NetworkUtil.getConnectivityStatusBoolean(this)) {  //check network status
            ...
            if (cancel) {
                ...
                progressDoalog = ProgressDialog.show(this, "", "Por favor espere", true);
            ...
            if (preferences.getString(PreferencePutter.PREF_ID, "").equals("")) {
                ...
                if (!savedID.equals(id)) {
                    Toast.makeText(getApplicationContext(), "ID no coincide\n\n" +
                            "Necesita conexion a network", Toast.LENGTH_SHORT).show();
                    hideKeyboard();
                } else {
                    if (savedID.equals(id) && savedPW.equals(password)) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                "Contraseña no coincide.", Toast.LENGTH_SHORT).show();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(final String result) {
            ...
            if (result.equals("connection error")) {
                ...
                editor.putString(PreferencePutter.DATE, "0");
           ...
           /*     mPasswordView.setError(getString(R.string.error_incorrect_password));
                mPasswordView.requestFocus();*/
                Toast.makeText(getApplicationContext(),"Contraseña no coincide\n o Error del servidor", Toast.LENGTH_SHORT).show();
